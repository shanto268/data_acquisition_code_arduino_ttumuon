...
n8=0
n9=0
Xadc8=np.zeros(10000) # number in function defined by (# collected by adc8)*(# of events in counter from "read_serial.py")
WTadc8=np.zeros(10000)
Xadc9=np.zeros(100000) # number in function defined by (# collected by adc9)*(# of events in counter from "read_serial.py")
WTadc9=np.zeros(100000) 
n8=0
n9=0
nevents=0
s8=np.zeros(10000)
...
with open('datafile_test.txt') as f:
   for line in f:          
       print line
